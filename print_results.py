...
def print_results(
    ...
    print(
        ...
        + str(results_stats_dic["n_images"])
    ...
    correct_notdogs = results_stats_dic["n_correct_notdogs"]
    correct_breeds = results_stats_dic["n_correct_breed"]
    total_images = results_stats_dic["n_images"]

    if print_incorrect_dogs and correct_dogs + correct_notdogs != total_images:
        print("\n**Misclassified Dogs:")
