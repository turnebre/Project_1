...
def calculates_results_stats(results_dic):
    ...
    Parameters:
      ...
      (index)idx 0 = pet image label (string)
        ...
        idx 4 = 1/0 (int)  where 1 = Classifier classifies image 'as-a' dog
            and 0 = Classifier classifies image 'as-NOT-a' dog.
    Returns:
     results_stats_dic - Dictionary that contains the results statistics (either a percentage or a count)
        where the key is the statistic's name (starting with 'pct' for percentage or 'n' for count)
        and the value is the statistic's value. See comments above and the previous topic Calculating Results
        in the class for details on how to calculate the counts and statistics.
    """
    ...
    # Loop through results_dict to gather counts
    ...
    results_stats_dic["pct_correct_breed"] = (
        float(results_stats_dic["n_correct_breed"] / results_stats_dic["n_dogs_img"])
        * 100
    )
